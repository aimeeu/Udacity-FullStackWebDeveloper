#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# PURPOSE: populate database after running database_setup.py
...
menuItem1 = MenuItem(name="French Fries",
                     description="with garlic and parmesan", price="2.99",
...
menuItem4 = MenuItem(name="Sirloin Burger",
                     description="Made with grade A beef", price="7.99",
...
menuItem5 = MenuItem(name="Root Beer",
                     description="16oz of refreshing goodness", price="1.99",
                     course="Beverage", restaurant=restaurant1)

session.add(menuItem5)
session.commit()

menuItem6 = MenuItem(name="Iced Tea", description="with Lemon", price=".99",
                     course="Beverage", restaurant=restaurant1)
...
menuItem2 = MenuItem(name="Peking Duck",
                     description=" a famous duck dish from Beijing[1] that "
                                 ...
                                 "crisp skin, with authentic versions of the "
                                 "dish serving mostly the skin and little "
                                 "meat, sliced in front of the diners by the "
                                 "cook",
...
menuItem3 = MenuItem(name="Spicy Tuna Roll", description="Spicy Tuna Roll",
                     price="8.50",
                     course="Appetizer", restaurant=restaurant2)

session.add(menuItem3)
session.commit()

menuItem4 = MenuItem(name="Nepali Momo",
                     description="Momo is a type of South Asian dumpling",
                     price="8.99", course="Appetizer",
...
menuItem5 = MenuItem(name="Beef Noodle Soup",
                     description="Hearty Chinese beef noodle soup",
                     price="14.99",
...
menuItem6 = MenuItem(name="Ramen", description="Makes your hair fall out",
                     price="10.99", course="Entree",
                     restaurant=restaurant2)
...
menuItem1 = MenuItem(name="Pho",
                     ...
                     price="15.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Tres Leches Cake",
                     ...
                     price="6.99", course="Dessert", restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Cauliflower Manchurian",
                     description="Golden fried cauliflower florets in a "
                                 ...
                                 "green onions",
                     price="11.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Shellfish Tower", description="Lots of shellfish",
                     price="12.99",
                     course="Entree", restaurant=restaurant1)
...
menuItem2 = MenuItem(name="Chicken and Rice", description="arroz con pollo",
                     price="10.99",
                     course="Entree", restaurant=restaurant1)
...
menuItem3 = MenuItem(name="Mom's Spaghetti", description="pasta",
                     price="12.99",
                     course="Entree", restaurant=restaurant1)
...
menuItem4 = MenuItem(
    ...
    description="ice cream", price="5.99", course="Dessert",
...
menuItem4 = MenuItem(
    name="Nigiri SamplerMaguro, Sake, Hamachi, Unagi, Uni, TORO!",
    description="Sushi", price="35.99", course="Entree",
    restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Tandoori Chicken",
                     description="Chicken marinated in yogurt and seasoned "
                                 "with a spicy mix(chili, tamarind among "
